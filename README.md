...
profile = {
    ...
    "education":    "ZUST — B.Sc. Computer Science and Technology",
    "stack":        ["python", "sql", "scikit-learn", "xgboost"],
...
Data scientist with **2 years 3 months** in the trenches of messy data — running experiments that hold, building models that explain, and analyses that answer the question actually being asked.

Focused on **tabular ML**, **interpretable models**, and the unglamorous discipline of writing tests for things that shouldn't break.

---

### `// stack`

![Python](https://img.shields.io/badge/Python-0b0c0e?style=flat-square&logo=python&logoColor=d4a445)
![MySQL](https://img.shields.io/badge/SQL-0b0c0e?style=flat-square&logo=mysql&logoColor=d4a445)
...
![XGBoost](https://img.shields.io/badge/XGBoost-d4a445?style=flat-square&logoColor=0b0c0e)
![LightGBM](https://img.shields.io/badge/LightGBM-d4a445?style=flat-square&logoColor=0b0c0e)
![SHAP](https://img.shields.io/badge/SHAP-d4a445?style=flat-square&logoColor=0b0c0e)
![MLflow](https://img.shields.io/badge/MLflow-0b0c0e?style=flat-square&logo=mlflow&logoColor=d4a445)
![pytest](https://img.shields.io/badge/pytest-0b0c0e?style=flat-square&logo=pytest&logoColor=d4a445)
...
```
ROC-AUC 0.778  ·  Gini 0.556  ·  KS 0.432
LightGBM · XGBoost · SHAP · MLflow · pytest
```
